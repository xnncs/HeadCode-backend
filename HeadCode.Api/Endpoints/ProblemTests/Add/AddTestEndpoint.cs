...
public class AddTestEndpoint : Endpoint<AddTestRequest, Results<Created, BadRequest<string>, InternalServerError>>
{
    ...
    public override async Task<Results<Created, BadRequest<string>, InternalServerError>> ExecuteAsync(AddTestRequest request, CancellationToken cancellationToken)
    {
