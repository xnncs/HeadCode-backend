...
public class GetTestsByProblemIdEndpoint : Endpoint<GetTestsByProblemIdRequest, Results<Ok<List<GetTestResponse>>, BadRequest<string>>>
{
    ...
    public override async Task<Results<Ok<List<GetTestResponse>>, BadRequest<string>>> ExecuteAsync(GetTestsByProblemIdRequest request, CancellationToken cancellationToken)
    {
        ...
        if (problem == null)
        {
            return TypedResults.BadRequest("Problem not found");
        }
